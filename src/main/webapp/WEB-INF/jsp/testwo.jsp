...
<script type="text/javascript" src="/blog/static/jquery/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="/blog/static/xheditor-1.2.2.min.js"></script>
<script type="text/javascript" src="/blog/static/xheditor_lang/zh-cn.js"></script>
...
<div style="display: none">
	...
	<h2>欢迎您进行博客编写</h2>
	<form action="<%=request.getContextPath()%>/saveArticle"  method="post">
	<div style="position:absolute;left:430px;top:16px"> 文章标题：<input name="blogTitle" type="text"/>
	文章类别：<select name="blogArticleType">
		<option value="1">原创</option>
		<option value="2">转载</option>
		<option value="3">翻译</option>
		</select>
	个人分类：<select name="blogType">
		<option value="1">java</option>
		<option value="2">linux</option>
		<option value="3">前端</option>
		<option value="4">程序人生</option>
		<option value="5">其他乱七八糟</option>
		<option value="6">框架</option>
		</select>
		<input  type="submit" value="保存"/>
	</div>
	<div class="section" style="position:absolute;left:246px;top:50px"><textarea id="preview" name="blogContext" rows="35" cols="120"></textarea></div>
</form>
</body>
</html>